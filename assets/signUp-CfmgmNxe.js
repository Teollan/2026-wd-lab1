import{S as c,A as s,R as r,c as l,a as i,b as d,m as u,H as m,F as b}from"./Footer-Ca_XvyZW.js";const o={SUBMIT:"sign_up::submit"},t=new c({error:null});t.addAction(o.SUBMIT,(e,a)=>{try{s.signUp(e),window.location.href=r.FEED}catch(n){a({error:n.message})}});const p=()=>{const{error:e}=t.getState();return`
  ...
  `};class f extends i{onComponentDidMount(){this.useStore(t),this.useStore(d),this.useStore(u)}getHtml(){return`
      ${m()}
